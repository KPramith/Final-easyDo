    ...
    if (isset($_GET['user_id'])) {
        ...
        if($result_set){
            if(mysqli_num_rows($result_set) == 1){
                ...
                //user not found
                header('Location: construction.php?err=user_not_found');
            }
        }else{
            //query unsuccessful
            header('Location: construction.php?err=query_fieled');
        }
            ...
            if (empty($errors)){
              ...
              $query .= "WHERE id = {$user_id} LIMIT 1";
               ...
               if($result){
                   ...
                   header('Location: construction.php?construction_modified=true');
               }else {
...
<head>
    ...
    <title>Modify Construction</title>
...
<header> 
    ...
    <span><a href="profile-construction.php? 
    ...
    <form action="modify-construction.php" method = "post" class="userform">
