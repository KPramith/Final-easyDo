...
if (isset($_GET['user_id'])) {
    ...
    if($result_set){
        ...
        //query unsuccessful
        header('Location: mechanical.php?err=query_fieled');
    }
}
            ...
            echo "<script>
                    document.addEventListener('DOMContentLoaded', function() {
                        Swal.fire({
                            ...
                            window.location = 'mechanical.php?carpentry_modified=true';
                        });
                    });
                  </script>";
        } else {
...
<body>
    ...
    <span><a href="profile-mechanical.php?user_id= <?php echo $user_id; ?>">< Back to Profile</a></span></h1>
        ...
        <form action="modify-mechanical.php" method="post" class="userform">
