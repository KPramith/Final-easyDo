...
<?php 
    ...
    $query = "SELECT * FROM workers WHERE work_type='Plumbing' ORDER BY user_name";
    ...
    while ($user = mysqli_fetch_assoc($users)) {
            ...
            $user_list .= "<td><a href=\"profile-plumbing.php?user_id={$user['id']}\">Go to Profile ></a></td>";
            $user_list .= "</tr>";
