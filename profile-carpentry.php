...
if (isset($_GET['user_id'])) {
    ...
    if($result_set) {
        ...
        // Query unsuccessful
        header('Location: carpentry.php?err=query_failed');
        exit();
    }
}
?>
...
<head>
    ...
    <title>Profile of Carpentry</title>
    ...
    <main>
        <div class="profile-header">
            ...
            <div class="profile-actions">
                ...
                <a href="carpentry.php" class="back-link">< Back to Carpentry list</a>
            </div>
        </div>
        ...
        <div class="profile-container">
            ...
            <div class="button-container">
                <a href="modify-carpentry.php?user_id=<?php echo htmlspecialchars($user_id); ?>" class="button">
                    Edit Profile
                </a>
