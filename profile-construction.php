...
if (isset($_GET['user_id'])) {
    ...
    if($result_set) {
        ...
        // Query unsuccessful
        header('Location: construction.php?err=query_failed');
        exit();
    }
}
?>
...
<head>
    ...
    <title>Profile of Construction</title>
    ...
    <main>
        <div class="profile-header">
            ...
            <div class="profile-actions">
                ...
                <a href="construction.php" class="back-link">< Back to Construction list</a>
            </div>
        </div>
        ...
        <div class="profile-container">
            ...
            <div class="button-container">
                <a href="modify-construction.php?user_id=<?php echo htmlspecialchars($user_id); ?>" class="button">
                    Edit Profile
                </a>
