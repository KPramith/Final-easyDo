...
if (isset($_GET['user_id'])) {
    ...
    if($result_set) {
        ...
        // Query unsuccessful
        header('Location: plumbing.php?err=query_failed');
        exit();
    }
}
?>
...
<head>
    ...
    <title>Profile of Plumbing</title>
    ...
    <main>
        <div class="profile-header">
            ...
            <div class="profile-actions">
                ...
                <a href="plumbing.php" class="back-link">< Back to Plumbing list</a>
            </div>
        </div>
        ...
        <div class="profile-container">
            ...
            <div class="button-container">
                <a href="modify-plumbing.php?user_id=<?php echo htmlspecialchars($user_id); ?>" class="button">
                    Edit Profile
                </a>
